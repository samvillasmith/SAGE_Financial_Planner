...
def main():
    print("Sage Researcher Service - Docker Deployment")
    print("===========================================")
    ...
    ecr_repository = "sage-researcher"
    ...
    try:
        services = run_command(
            [
                ...
                region,
                "--query",
                "ServiceSummaryList[?ServiceName=='sage-researcher'].ServiceArn",
                "--output",
                "json",
            ],
            capture_output=True,
        ...
        if services:
            ...
            if service_arns:
                                ...
                                "ImageRepository": {
                                    ...
                                    "ImageConfiguration": {
                                        ...
                                        "RuntimeEnvironmentVariables": {
                                            ...
                                            "SAGE_API_ENDPOINT": os.environ.get(
                                                "SAGE_API_ENDPOINT", ""
                                            ),
                                        },
                                    },
                ...
                print("  2. Select 'sage-researcher' service")
